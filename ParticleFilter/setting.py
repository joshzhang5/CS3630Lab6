...
MARKER_TRANS_SIGMA = 2     # translational err in inch (grid unit)
MARKER_ROT_SIGMA = 50      # rotational err in deg

PARTICLE_MAX_SHOW = 500     # Max number of particles to be shown in GUI (for speed up)

ROBOT_CAMERA_FOV_DEG = 56.57  # Robot camera FOV in degree
