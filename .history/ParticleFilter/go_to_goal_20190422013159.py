...
class CozmoWarehouseWorker:
    ...
    async def __execute_directions(self, directions):
        ...
        print("TOTAL MOVEMENT IN X: ", math.sqrt((self.robot.pose.position.x - initial_position.x) ** 2 + (self.robot.pose.position.y - initial_position) ** 2))
        initial_position = self.robot.pose.position
        ...
        print("TOTAL MOVEMENT IN Y: ", math.sqrt((self.robot.pose.position.x - initial_position.x) ** 2 + (self.robot.pose.position.y - initial_position) ** 2))
