...
class GUIWindow():
    ...
    def _show_mean(self, x, y, heading_deg, confident=False):
        ...
        fov_lx, fov_ly = rotate_point(15, 0, heading_deg + ROBOT_CAMERA_FOV_DEG / 2)
        fov_rx, fov_ry = rotate_point(15, 0, heading_deg - ROBOT_CAMERA_FOV_DEG / 2)
        self.colorLine(location, (location[0]+fov_lx, location[1]+fov_ly), color='#222222', linewidth=2, dashed=True)
        self.colorLine(location, (location[0]+fov_rx, location[1]+fov_ry), color='#222222', linewidth=2, dashed=True)
    ...
    def _show_robot(self, robot):
        ...
        self.colorLine(coord, (coord[0]+fov_lx, coord[1]+fov_ly), color='#222222', linewidth=2)
        self.colorLine(coord, (coord[0]+fov_rx, coord[1]+fov_ry), color='#222222', linewidth=2)
