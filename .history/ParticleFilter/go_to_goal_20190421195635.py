...
class CozmoWarehouseWorker:
    ...
    async def drive_to(directions):
        ...
        if isinstance(directions, (list,)):
            for dest in directions:
                directions_to_dest = dest - current_pose
                await self.__execute_directions(directions_to_dest)
    ...
    async def drive_with_directions(directions):
