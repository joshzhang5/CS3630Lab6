...
class CozmoWarehouseWorker:
    ...
    def __init__(self, robot: cozmo.robot.Robot):
        ...
        self.drop_off_pose = Pose(x=21.75, y=9, z=0, angle_z=degrees(90))
    ...
    async def __execute_directions(self, directions):
        ...
        print("TOTAL MOVEMENT IN X: ", math.sqrt((self.robot.pose.position.x - initial_position.x) ** 2 + (self.robot.pose.position.y - initial_position.y) ** 2))
        initial_position = self.robot.pose.position
        ...
        print("TOTAL MOVEMENT IN Y: ", math.sqrt((self.robot.pose.position.x - initial_position.x) ** 2 + (self.robot.pose.position.y - initial_position.y) ** 2))
