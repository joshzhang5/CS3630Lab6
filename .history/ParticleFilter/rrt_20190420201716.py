...
class CozmoExplorer:
    ...
    def __init__(self, robot, x_0=0, y_0=0, theta_0=0, map_scale=25):
        ...
        self.goal_node = None 
        self.blocks_seen = {}
        threading.Thread(target=self.run_cmap_gui).start()

    def run_cmap_gui(self):
    ...
    def update_pose(self):
        movement_since_last_node = self.robot.pose - self.last_pose
        curr_arena_pose = self.last_arena_pose + movement_since_last_node
        print("MOVE SINCE LAST POSE:", movement_since_last_node)
         print("CURR ARENA POSE:", movement_since_last_node)
