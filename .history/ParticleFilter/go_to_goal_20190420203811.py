...
goal_pose = cozmo.util.Pose(6 * 25.4, 12 * 25.4, 0, angle_z=cozmo.util.Angle(degrees=0))
current_pose = None
async def run(robot: cozmo.robot.Robot):
    ...
    current_pose = current_pose + (robot.pose - last_robot_pose)
    # recalculate where cosimo is
    #cosimo.update_pose()
    #print("COZMO THINKS IT IS AT AFTER DRIVING TO PICKUPZONE: ", cosimo.last_arena_pose)
    ...
    while True:
      ...
      #print("COZMO THINKS IT IS AT AFTER PICKING UP CUBE: ", cosimo.last_arena_pose)
