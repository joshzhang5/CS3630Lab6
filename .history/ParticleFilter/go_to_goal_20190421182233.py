...
class CozmoWarehouseWorker:
    ...
    def __init__(self, robot:cozmo.robot.Robot, current_arena_pose):
        ...
        self.drop_off_directions = [Pose(x=3, y=4.5, 0, angle_z=degrees(0)), Pose(x=21.75, y=4.5, 0, angle_z=degrees(90)), drop_off_pose]
        self.pick_up_directions = [Pose(x=21.75, y=4.5, 0, angle_z=degrees(90)), Pose(x=3, y=4.5, 0, angle_z=degrees(0)), pick_up_pose]
