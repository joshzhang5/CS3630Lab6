...
class CozmoWarehouseWorker:
    ...
    def update_current_arena_pose(self):
        arena_initial_pose_mm = rotate_point(self.last_robot_pose, diff_heading_deg(self.last_robot_pose.rotation.degrees, self.current_arena_pose.rotation.degrees))
        arena_final_pose_mm = rotate_point(self.robot.pose, )
