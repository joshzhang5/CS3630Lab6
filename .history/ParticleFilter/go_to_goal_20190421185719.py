...
class CozmoWarehouseWorker:
    ...
    def update_current_arena_pose(self):
        initial_local_to_arena_heading_diff = diff_heading_deg(self.last_robot_pose.rotation.degrees, self.current_arena_pose.rotation.degrees)
        arena_initial_pose_mm = rotate_point(self.last_robot_pose.position.x, self.last_robot_pose.position.y, initial_local_to_arena_heading_diff)

        change_in_heading = diff_heading_deg(self.robot.pose.rotation.degrees, self.last_robot_pose.rotation.degrees)

        final_local_to_arena_angle_diff = diff_heading_deg(, self.current_arena_pose.rotation.degrees)
