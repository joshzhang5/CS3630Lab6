...
class CozmoWarehouseWorker:
    ...
    async def __execute_directions(self, directions):
        ...
        await self.robot.turn_in_place(angle=self.robot.current_arena_pose.rotation.angle_z).wait_for_completed()
        ...
        await self.robot.turn_in_place(angle=directions.rotation.angle_z)
